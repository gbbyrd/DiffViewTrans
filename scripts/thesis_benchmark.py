    ...
    for batch in tqdm(dataloader):
        ...
        for i in range(opt.batch_size):
            ...
            img_names = {
                ...
                'translated_depth': os.path.join(translated_rgb_dataset_path,
...
if __name__ == "__main__":
    ...
    if opt.run_inference:
        ...
        run_translation_rgb_depth_for_benchmark(model, opt, 'training')
        run_translation_rgb_depth_for_benchmark(model, opt, 'validation')
